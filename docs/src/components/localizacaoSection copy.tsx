      ...
      <section className="hero-heading-right">
        <div className="w-layout-blockcontainer image-wrapper-title w-container">
          <img 
            ...
            id="sobre" 
            loading="lazy" 
            srcSet="./src/assets/images/68781aa48c5d930779c98278_cao-sorrindo-p-500.png 500w, ./src/assets/images/68781aa48c5d930779c98278_cao-sorrindo-p-800.png 800w, ./src/assets/images/68781aa48c5d930779c98278_cao-sorrindo.png 1028w" 
          />
        </div>
            ...
            <div className="hero-split">
              <a href="https://maps.google.com/?q=Rodovia+Bunjiro+Nakao,+45439+-+Jardim+Margarida,+Vargem+Grande+Paulista+-+SP,+06730-000" className="w-inline-block" target="_blank" rel="noopener noreferrer">
                <img 
                  ...
                  srcSet="./src/assets/images/687aa83ae4bcbf04629eb9ee_google-maps-p-500.png 500w, ./src/assets/images/687aa83ae4bcbf04629eb9ee_google-maps.png 560w" 
